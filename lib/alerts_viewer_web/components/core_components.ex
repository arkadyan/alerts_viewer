defmodule AlertsViewerWeb.CoreComponents do
  @moduledoc """
  ...
  @doc """
  Renders a form for interface controls.

  ## Examples

      <.controls_form phx-change="update-controls">
        <.input field={@form[:email]} label="Email"/>
      </.controls_form>
  """
  attr(:rest, :global,
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AlertsViewerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AlertsViewerWeb.Gettext, "errors", msg, opts)
    end
  end
