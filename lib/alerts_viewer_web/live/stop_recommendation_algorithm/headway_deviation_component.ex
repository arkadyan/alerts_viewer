defmodule AlertsViewer.StopRecommendationAlgorithm.HeadwayDeviationComponent do
  @moduledoc """
  Component for controlling the headway deviation stop recommendation algorithm.
  """
    ...
    <div class="flex space-x-16 items-center">
      <.controls_form phx-change="update-controls" phx-target={@myself}>
        ...
        <.input
          ...
          label="Median Headawy Deviation (minutes)"
        />
        <span class="ml-1">
          <%= @median %>
        </span>
        ...
        <.input
          ...
          max={@peak_max}
          step={@peak_interval}
          label="Peak Headawy Deviation (minutes)"
        />
        <span class="ml-1">
          <%= @peak %>
        </span>
